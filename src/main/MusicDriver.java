...
public class MusicDriver {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("Use the command 'generate' to generate a new motif, or read a motif from JSON using 'read'.");
			Motif melody = null;
			...
			if(!bulkMelodies.isEmpty()) {
				...
				while(true) {
					...
					while(melody != null) {
						...
						case "p":
						case "play":
							playMotif(melody, playableNotesPerChord);
							break;
						case "w":
						case "write":
	...
	public static HashMap<String, ArrayList<String>> initializeChordLibrary(){
		...
		ArrayList<String> playableGSharp = new ArrayList<String>(Arrays.asList("C", "D#", "F", "F#", "G", "G#", "A#", "B"));
		...
		ArrayList<String> playableDSharp = new ArrayList<String>(Arrays.asList("C","C#", "D", "D#", "F", "F#", "G", "A#"));
	...
	public static void playMotif(Motif melody, HashMap<String, ArrayList<String>> playableNotesPerChord) {
		Synthesizer synth;
		try {
